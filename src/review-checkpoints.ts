...
const MAX_REVIEW_PATCH_SOURCES = 128;
  ...
  return {
    ...
    async reviewChanges({
      ...
      if (includePatch) {
        ...
        trimOldestEntries(patchSources, MAX_REVIEW_PATCH_SOURCES);
      }
...
function trimOldestEntries<K, V>(entries: Map<K, V>, limit: number): void {
